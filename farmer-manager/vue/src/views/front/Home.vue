<template>
  <div class="main-content">
    ...
    <div style="width: 80%; margin: 20px auto;">
        ...
        <div style="width: 50%; height: 330px; margin-left: 17px">
          <el-tabs v-model="activeName">
            <el-tab-pane label="扶贫资讯" name="first">
              <div style="display: flex; line-height: 48px; height: 48px" v-for="item in informationData" :key="item.id">
            ...
            <el-tab-pane label="扶贫政策" name="second">
              <div style="display: flex; line-height: 48px; height: 48px" v-for="item in policyData" :key="item.id">
      ...
      <div>
        <el-row :gutter="20">
          <el-col :span="8" style="margin-bottom: 50px" v-for="item in agritainmentData" :key="item.id">
