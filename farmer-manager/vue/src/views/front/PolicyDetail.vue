<template>
  <div class="main-content">
    <div style="width: 65%; margin: 20px auto">
      ...
      <div style="margin-top: 20px">
        <el-row :gutter="10" style="margin-bottom: 30px" v-for="item in commentData" :key="item.id">
          <el-col :span="4">
          ...
          <el-col :span="20">
            ...
            <el-row style="height: 40px; line-height: 40px; margin-bottom: 10px" v-for="(child, index) in item.children" :key="index">
              <el-col :span="4">
                <div style="display: flex; align-items: center">
